$.fn.selectDate = function(){
			...
			var yearSel = document.getElementById('yearUl')
			var monthSel = document.getElementById('monthUl')
			var daySel = document.getElementById('daysUl')
	
			for(var y = maxYear;y >= minYear;y--){
				var yearOpt = document.createElement('li')
				yearOpt.value = y
			...
			$("#month").click(function(){
				removeOption(daySel)
				var year = parseInt($("#year span").text().split("年")[0]) ;
				var month = parseInt($("#month span").text().split("月")[0]);
